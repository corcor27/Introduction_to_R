...
>Note: You can also do this through the terminal (console pane) using ‘attrib +r’ for windows or ‘chomd 444’ for linux/mac. 
...
This is a simple introduction to getting your data into R. In some cases there will be significant complications (e.g., many files, large data size, unusual file format, etc.).
